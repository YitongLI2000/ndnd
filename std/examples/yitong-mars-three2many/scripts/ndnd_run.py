...
# # --- Scaling Configuration ---
# # How many consumers to activate (1 to 3)
# # Example: 1 means only con0 runs.
# NUM_ACTIVE_CONSUMERS = 3

# # How many producers each active consumer should request data from (1 to 5)
# # Example: 5 means con0 requests from pro0-pro4.
# # Example: 3 means con0 requests from pro0-pro2.
# NUM_PRODUCERS_PER_CONSUMER = 15
...
# # --- Topology Definition (DO NOT CHANGE) ---
# # The physical topology remains fixed to support the maximum scale.
# NODES = [
#     # 15 Producers
#     'pro0', 'pro1', 'pro2', 'pro3', 'pro4', 'pro5', 'pro6', 'pro7', 'pro8', 'pro9', 
#     'pro10', 'pro11', 'pro12', 'pro13', 'pro14',
...
#     """Ensures the scaling configuration fits within the physical topology."""
#     MAX_TOPO_CONSUMERS = 3
#     MAX_TOPO_PRODUCERS_PER_BLOCK = 5 # The topology is built in blocks of 5 producers
...
#     print(f"✅ Scaling Check Passed: {NUM_ACTIVE_CONSUMERS} Consumers, {NUM_PRODUCERS_PER_CONSUMER} Producers/Consumer.")
...
# def configure_dynamic_routing(net):
#     print(f"\n=== Step 3: Configuring Dynamic Routes for {NUM_ACTIVE_CONSUMERS} Consumers ===")
    
#     # Generate list based on scaling config
#     consumers = [f'con{i}' for i in range(NUM_ACTIVE_CONSUMERS)]
...
#     # Calculate exactly which producers are needed based on active consumers
#     producers_needed = []
#     for i in range(NUM_ACTIVE_CONSUMERS):
#         start_idx = i * 5
#         end_idx = start_idx + NUM_PRODUCERS_PER_CONSUMER
...
#     producers_needed = sorted(list(set(producers_needed))) # Unique and sorted
...
#     # Step 3: Dynamic Route Configuration for active consumers
#     configure_dynamic_routing(net)
...
#         # Calculate Producer Range based on scaling config
#         # The topology assumes blocks of 5 (e.g., con0 -> pro0-4)
#         # We limit the upper bound by NUM_PRODUCERS_PER_CONSUMER
#         start_idx = i * 5
#         end_idx = (i * 5) + NUM_PRODUCERS_PER_CONSUMER - 1
#         range_arg = f"{start_idx}-{end_idx}"
